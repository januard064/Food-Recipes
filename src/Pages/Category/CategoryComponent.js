        ...
        <>
            ...
            </div>
            {
                ...
                <div className="col-10 col-sm-10 col-md-6 offset-1 offset-sm-1 offset-md-3 detail">
                    <div className="row">
                        <div className="detail-title"><p style={{  fontSize:22 }}>{categorys.strCategory}</p></div>
                        <div><Icon className="close" icon="ant-design:close-circle-outlined" onClick={toggleHandler} /></div>
